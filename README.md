...
- UTF-8 and IME input, mouse tracking and SGR mouse reporting, bounded OSC 50 runtime font-family switching, Kitty OSC 66 cell-spanning and fractionally scaled text, scrollback that returns to the bottom on input, search, selection, and clipboard copy/paste
