...
- Inline images using 7/8-bit Sixel, Kitty graphics (including Unicode placeholders used by TUI frameworks), and iTerm2 OSC 1337 ([supported subset and example](docs/image-protocols.md))
